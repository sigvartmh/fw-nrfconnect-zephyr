...
#include <pm_config.h>
#define SLOT_SIZE (PM_CFG_APP_SIZE - CONFIG_MCUBOOT_SCRATCH_SIZE - CONFIG_MCUBOOT_STORAGE_SIZE)
#define FLASH_AREA_IMAGE_0_OFFSET PM_CFG_MCUBOOT_ADDRESS
...
#define FLASH_AREA_IMAGE_SCRATCH_SIZE CONFIG_MCUBOOT_SCRATCH_SIZE
#define FLASH_AREA_IMAGE_STORAGE_OFFSET FLASH_AREA_IMAGE_SCRATCH_OFFSET + FLASH_AREA_IMAGE_SCRATCH_SIZE
#define FLASH_AREA_IMAGE_STORAGE_SIZE CONFIG_MCUBOOT_STORAGE_SIZE

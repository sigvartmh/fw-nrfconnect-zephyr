...
#define FLASH_AREA_SCRATCH_OFFSET CONFIG_MCUBOOT_IMAGE_1_OFFSET
#define FLASH_AREA_SCRATCH_SIZE CONFIG_MCUBOOT_SCRATCH_OFFSET - CONFIG_MCUBOOT_IMAGE_1_OFFSET
#define FLASH_AREA_STORAGE_OFFSET CONFIG_MCUBOOT_IMAGE_1_OFFSET
#define FLASH_AREA_STORAGE_SIZE CONFIG_FLASH_BASE_ADDRESS + CONFIG_LOAD_SIZE

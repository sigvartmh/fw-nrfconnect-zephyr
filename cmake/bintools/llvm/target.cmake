...
if ("${ARCH}" STREQUAL "arm")
  set_ifndef(GNUARMEMB_TOOLCHAIN_PATH "$ENV{GNUARMEMB_TOOLCHAIN_PATH}")
	find_program(CMAKE_OBJCOPY ${triple}-objcopy PATH ${GNUARMEMB_TOOLCHAIN_PATH}/bin NO_DEFAULT_PATH)
  find_program(CMAKE_READELF ${triple}-readelf PATH ${GNUARMEMB_TOOLCHAIN_PATH}/bin NO_DEFAULT_PATH)
else()
